...
getgenv().ToTarget = function(Point)
	...
	pcall(function() 
		tween = game:GetService("TweenService"):Create(LocalPlayer.Character.HumanoidRootPart,TweenInfo.new((Point.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude/250, Enum.EasingStyle.Linear),{CFrame = Point})
	end);tween:Play()

	if (Point.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 200 then
